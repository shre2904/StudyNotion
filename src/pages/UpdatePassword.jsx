    ...
    <div className='grid min-h-[calc(100vh-3.5rem)] place-items-center'>
      {
        loading ? (
            ...
            <div className='w-[500px] p-4 lg:p-8'>
                ...
                <form onSubmit={handleOnSubmit}>
                    <label className='relative'>
                        <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">New Password <sup className='text-pink-100'>*</sup></p>
                        <input 
                            required
