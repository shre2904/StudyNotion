    ...
    <div>
      ...
      text-white justify-between  '>
        ...
        <div className='group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
            ...
            <div className='flex flex-row item-center gap-2 rounded-full px-10 py-[5px]
            transition-all duration-20 group-hover:bg-richblack-900'>
      ...
      <div className='bg-pure-greys-5 txt-richblack-700'>
                ...
                <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-content gap-7'>
