  ...
  return (
    <div>
      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white text-center'>
            <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                Driving Innovation in Online Education for a 
                <HighlightText text={"Brighter Future"}/>
                <p className='mx-auto mt-3 text-semibold text-center text-base font-medium text-richblack-300 lg:w-[95%]'>Studynotion is at the forefront of driving innovation in online education.
            ...
            <div className='absolute buttom-0 w-[100%] translate-x[50%] translate-y-[85%] grid grid-cols-3  gap-3 lg:gap-5'>
      ...
      {/* section3 */}
      <section>
        <div className='flex flex-col w-11/12 mx-auto max-w-maxContent justify-between gap-5 text-richblack-500'>
            {/* founding story div  */}
            <div className=' flex flex-col items-center lg:flex-row justify-center gap-10 '>
                {/* founding stor left box */}
                    ...
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                        As experienced educators ourselves, we witnessed firsthand the
                         limitations and challenges of traditional education systems.
                          We believed that education should not be confined to the walls of a classroom
                           or restricted by geographical boundaries. We envisioned a platform that could bridge 
                ...
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    ...
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                        With this vision in mind, we set out on a journey to create an e-learning
                         platform that would revolutionize the way people learn. Our team of dedicated experts 
                         worked tirelessly to develop a robust and intuitive platform that combines cutting-edge
      ...
      {/* section5 */}
      <section className='w-11/12 mx-auto gap-10 flex flex-col max-w-maxContent justify-between text-white my-20'>
      <LearningGrid/>
      <ContactFormSection />
      </section>
